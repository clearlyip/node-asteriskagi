...
export class AGIChannel extends events.EventEmitter {
  ...
  constructor(props: {socket: net.Socket, remoteServer: string | false, channel?: string, language?: string, uniqueid?: string, version?: string, callerid?: string, calleridname?: string, callingpres?:string, callingani2?:string, callington?:string, callingtns?:string, dnid?:string, rdnis?:string, context?:string, extension?:string, priority?:string, enhanced?:string, accountcode?:string, threadid?:string}) {
    super();
